...
public class MemberRegisterDto {
    ...
    public static Member toEntity(MemberRegisterDto memberRegisterDto){
    ...
    @Builder
    public MemberRegisterDto(String name, String email, String provider, String userId, String password, MemberRole memberRole) {
        this.name = name;
        this.email = email;
